...
export const addField = field => state => {
...
export const onFieldChange = (name, value) => state => {
  const updateState = R.compose(
    validateForm,
    adjustFormField(
      name,
...
export const onFormSubmitSuccess = data => state => {
  const updateState = R.compose(
    R.assoc("data", data),
...
export const onFormSubmitError = error => state => {
  const updateState = R.compose(
    R.assoc("error", error),
